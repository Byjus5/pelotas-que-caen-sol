...
function setup(){
    ...
    //planos y cuerpo de bloques creados
    var plane_options={
      isStatic: true
    }
    ...
    //múltiples partículas de cuerpos creadas 
    ...
    //todos los tres cuerpos rotadores creados
    var rotator_options={
      isStatic:true
    };
...
function draw(){
  ...
  //creada la figura para el plano y postura
  rect(plane.position.x,plane.position.y,1200,20);
  rect(block1.position.x,block1.position.y,150,20);
  rect(block2.position.x,block2.position.y,150,20);

  //creada la forma para todas las partículas
  ...
  //creada la forma para todos los rotadores
